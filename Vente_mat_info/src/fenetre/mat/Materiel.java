...
public class Materiel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCherche.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtChercheActionPerformed(evt);
            }
        });
...
//======================================================================================= Clique Tableau
    ...
    private void tableMaterielMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMaterielMouseClicked
        try {
            ...
            rs.close();
            smt.close();
            btnAjouter.setEnabled(false); // Active le bouton btnAjouter}
...
//=========================================================================================== Modifier
    ...
    private void btnModifierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifierActionPerformed
        ...
        if (numMat1 != 0 && designe != null && !designe.isEmpty() && pu != null && !pu.isEmpty() && stock != null && !stock.isEmpty()) {
...
//======================================================================================== et le manao recherche
    ...
    private void txtChercheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtChercheActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtChercheActionPerformed
